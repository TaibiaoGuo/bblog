...
# encoding:utf-8
'''
 @Time     :2020/3/23 4:16 AM
 @Author   :TaibiaoGuo Puji
 @FileName :FileHelper
...
udfs_utils = ipfsapi.connect(host=Config.ipfs_host, port=Config.ipfs_port)
print(Config.ipfs_host,Config.ipfs_port)
udfs_utils.res = {}
