...
var Web3Helper = {
    ...
    isNetworkConnected: function() {
        ...
        if (netId != Config.NET_ID) {
            switch (netId) {
                case "1":
                    return "您当前连接的是以太坊主网，请先切换至优壹区块链网络";
                case "2":
                    return "您当前连接的是Morden测试网，请先切换至优壹区块链网络";
                case "3":
                    return "您当前连接的是ropsten测试网，请先切换至优壹区块链网络";
                case "4":
                    return "您当前连接的是Rinkeby测试网，请先切换至优壹区块链网络";
                case "42":
                    return "您当前连接的是Kovan测试网，请先切换至优壹区块链网络";
                default:
                    return "未知网络，请先切换至优壹区块链网络";
            }
        }else{
